...
z.install = function() {
	F.prototype.equal = J.prototype.equal = function(e) {
		return z(this, e)
	}
};
...
z.restore = function() {
	F.prototype.equal = W, J.prototype.equal = X
};
var Y = {
	ES256: Z(256),
	ES384: Z(384),
...
var We = ze,
	...
	et = function(e, t) {
		...
		if ("number" === r && isFinite(e)) return t.long ? function(e) {
			...
			if (t >= Ye) return tt(e, t, Ye, "hour");
			if (t >= Ze) return tt(e, t, Ze, "minute");
			if (t >= Xe) return tt(e, t, Xe, "second");
			return e + " ms"
		}(e) : function(e) {
			var t = Math.abs(e);
			...
			if (t >= Xe) return Math.round(e / Xe) + "s";
			return e + "ms"
		}(e);
	...
	nt = K((function(e, t) {
		...
		ne.prototype.parse = function(e) {
			...
			e = e.replace(n, ae), r("hyphen replace", e), e = e.replace(i[K], "$1$2$3"), r("comparator trim", e, i[K]), e = (
				e = (e = e.replace(i[P], "$1~")).replace(i[$], "$1^")).split(/\s+/).join(" ");
			var o = t ? i[B] : i[L],
...
function xt(e, t) {
	var r = kt(e) || function(e) {
		...
		n = r.length,
		i = !!n;
	for (var o in e) !t && !vt.call(e, o) || i && ("length" == o || Rt(o, n)) || r.push(o);
	return r
}
...
var Pt = function(e, t, r, n) {
		...
		return r < 0 && (r = Et(o + r, 0)),
			function(e) {
				return "string" == typeof e || !kt(e) && It(e) && "[object String]" == bt.call(e)
		...
		return "number" == typeof e && e == function(e) {
			var t = function(e) {
					...
					if ((e = function(e) {
							...
							e = e.replace(Dt, "");
							var r = Mt.test(e);
							return r || Nt.test(e) ? Bt(e.slice(2), r ? 2 : 8) : $t.test(e) ? NaN : +e
						}(e)) === 1 / 0 || e === -1 / 0) {
						return 17976931348623157e292 * (e < 0 ? -1 : 1)
					}
					return e == e ? e : 0
...
var Zt = function(e) {
		...
		return "function" == typeof r && r instanceof r && Jt.call(r) == zt
	},
	...
	gr = function(e, t, r, n) {
		...
		return c(u, (function(t, n) {
			...
			if (void 0 !== d.nbf && !r.ignoreNotBefore) {
				...
				if (d.nbf > o + (r.clockTolerance || 0)) return i(new Ge("jwt not active", new Date(1e3 * d.nbf)))
			}
...
class Tr extends class {
	...
	_checkResponseSign(e, t) {
		...
		const r = this._getSignStr(e, t),
			i = JSON.parse(e).sign,
			o = n.createVerify(kr[this.options.signType]);
	...
	_notifyRSACheck(e, t, r) {
		...
		return n.createVerify(kr[r]).update(i, "utf8").verify(this.options.alipayPublicKey, t, "base64")
	}
	_checkNotifySign(e) {
		const t = e.sign;
...
var Ir = function(e = {}) {
		return e.clientType = e.clientType || __ctx__.PLATFORM, e.appId = e.appid, e.secret = e.appsecret, R(Rr, e)
	},
	Pr = function(e = {}) {
		return e.clientType = e.clientType || __ctx__.PLATFORM, e.appId = e.appid, R(Tr, e)
	};
...
async function Nr({
	...
	const i = $r.command,
		...
		a = await P.where(s).orderBy("created_at", "desc").limit(1).get();
	if (S("verifyRecord:", a), a && a.data && a.data.length > 0) {
		const e = a.data[0];
		return S("upRes", await P.doc(e._id).update({
			state: 1
		})), {
			code: 0,
			msg: "验证通过"
...
var Wr = Object.freeze({
	...
	loginByEmail: async function({
		...
		if (S("userInDB:", c), c && c.data && c.data.length > 0) {
			...
			r && (t.password = M(r)), t.my_invite_code = n;
			const s = await Dr(t, {
				needPermission: o
			});
			return 0 !== s.code ? s : { ...s,
	...
	login: async function({
		...
		if (m && m.error_times >= u) return {
			code: 10103,
			msg: `密码错误次数过多，请${k(m.last_error_time+1e3*f)}再试。`
		};
		if (M(t) === l) {
			const e = p.indexOf(m);
			e > -1 && p.splice(e, 1);
	...
	register: async function(e) {
		...
		e.password = M(e.password), e.my_invite_code = a;
		const f = await Dr(e, {
			needPermission: n
		});
		return 0 !== f.code ? f : { ...f,
...
const Xr = ["init", "encryptPwd"],
	Zr = {};
for (const e in Wr) Xr.indexOf(e) > -1 ? Zr[e] = Wr[e] : Zr[e] = O(Wr[e]);
module.exports = Zr;
