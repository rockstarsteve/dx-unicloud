...
uniID.init({
	"passwordSecret": "111111", // 用于加密用户密码
	"tokenSecret": "222222", // 用于生成token
	"tokenExpiresIn": 6000, // token过期时间
	"passwordErrorLimit": 6, // 同一个ip密码错误最大重试次数
	"passwordErrorRetryTime": 3600, // 超过密码重试次数之后的等待时间
	"mp-weixin": {
		"oauth": {
			"weixin": {
				"appid": "wxa5a0f11820fab2ed",
				"appsecret": "2e764e347813cd727058ca0bd9a0fd1a"
			}
		}
	},
})
